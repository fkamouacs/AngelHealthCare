...
describe('usage test 1', () => {
    ...
    it('login test and navigate different tabs and add a resource item', () => {
        ...
        cy.get('button').contains('log in', {matchCase: false}).should('be.visible').trigger("click");
        ...
        cy.get('button').contains('login', {matchCase: false}).should('be.visible').trigger("click");

        cy.get('button').contains('rooms', {matchCase: false}).should('be.visible').trigger("click");
        cy.get('button').contains('resources', {matchCase: false}).should('be.visible').trigger("click");
        cy.get('button').contains('processes', {matchCase: false}).should('be.visible').trigger("click");
        cy.get('button').contains('accounts', {matchCase: false}).should('be.visible').trigger("click");
        cy.get('button').contains('view messages', {matchCase: false}).should('be.visible').trigger("click");

        cy.get('button').contains('open drawer', {matchCase: false}).should('be.visible').trigger("click");
        cy.get('.MuiDrawer-root > .MuiPaper-root').contains('Add New Resource', {matchCase: false}).should('be.visible');
        cy.get('span').contains('Add New Resource', {matchCase: false}).should('be.visible').trigger("click");
        ...
        cy.get('button').contains('add resource', {matchCase: false}).should('be.visible').trigger("click");
        cy.get('button').contains('resources', {matchCase: false}).should('be.visible').trigger("click");
